...
import { View, Text, Image, Animated, StyleSheet, StatusBar ,TouchableOpacity, Modal} from 'react-native';
import Variables from '../config/Variables.js';
import COLORS from '../config/Colors.js';
import { ParallaxSwiper, ParallaxSwiperPage } from 'react-native-parallax-swiper';
import { LinearGradient } from "expo";
import ChooseSignUpMethod from './SignUpStackNav/ChooseSignUpMethod.js';
    ...
    render() {
      return (
        ...
        <StatusBar barStyle="light-content"/>
          <TouchableOpacity style={styles.signupButtonContainer} onPress={() => {this.props.setModalVisible(true)}}>
            <Text style={{color: 'white', fontFamily: 'HkGrotesk_Bold', fontSize: 20}}>Sign up</Text>
          </TouchableOpacity>
        ...
        >
          <ParallaxSwiperPage
            BackgroundComponent={
              <LinearGradient style={styles.gradient} colors={[COLORS.GRADIENT_COLOR_SIGNUP_1, COLORS.GRADIENT_COLOR_SIGNUP_2]}>
              <View opacity={0.5}>
                <Image
          ...
          <ParallaxSwiperPage
            ...
            ForegroundComponent={
              <View style={styles.foregroundTextContainer}>
                <Image style={styles.glyph} source={require('../assets/signup/signup_glyph_1.png')}/>
          ...
          <ParallaxSwiperPage
            ...
            ForegroundComponent={
              <View style={styles.foregroundTextContainer}>
                <Image style={styles.glyph} source={require('../assets/signup/signup_glyph_2.png')}/>
          ...
          <ParallaxSwiperPage
            ...
            ForegroundComponent={
              <View style={styles.foregroundTextContainer}>
              <Image style={styles.glyph} source={require('../assets/signup/signup_glyph_3.png')}/>
